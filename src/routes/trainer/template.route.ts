...
import templateController from '../../controllers/trainer/template.controller';
import requirePermissions from '../../middlewares/require-permissions';
import templateValidation from '../../validations/trainer/template.validation';
...
router.get('/most-popular', templateController.getMostPopularTemplates);
